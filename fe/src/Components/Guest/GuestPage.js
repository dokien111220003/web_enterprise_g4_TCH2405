      ...
      <div className="studentpage-left-container">
        ...
        <div className="left-content">
          <div className="left-content-header">
            <h1>IT Faculty</h1>
            <li><NavLink exact to='/viewallG' activeClassName="active" className="nav-link-text">View more here</NavLink></li>
          </div>
        ...
        <div className="viewmore">
          <div className="li-viewmore">
            <li><NavLink exact to='/viewallG' activeClassName="active">View More Faculty</NavLink></li>
